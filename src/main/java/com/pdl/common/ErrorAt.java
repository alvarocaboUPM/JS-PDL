...
public class ErrorAt {
    ...
    private String getAnalizer(){
        if(this.code<10) return "Main";
        else if(this.code <100) return "Lexical Analyzer";
        else if(this.code <200) return "Sintactic Analyzer";
        else if(this.code < 300) return "Semantic Analyzer";
    ...
    public static int getAnalizer(int c){
        ...
        else if(c <200) return 2;
        else if(c < 300) return 3;
        else return -1;
    }
