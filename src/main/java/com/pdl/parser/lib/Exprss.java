...
/**
 * Este código implementa el algoritmo Shunting Yard para evaluar una expresión booleana.
 ...
 * precedencia en la pila y los agrega a la cola de salida antes de agregar el operador actual.
 * Cuando encuentra un operando, lo agrega directamente a la cola de salida.
 * Una vez que se han procesado todos los tokens, vacía la pila de operadores en la cola de salida.
 *
 * Luego, el código evalúa la expresión utilizando una pila de evaluación.
 * Recorre la cola de salida, agregando operandos a la pila de evaluación y aplicando operadores a los operandos en la pila.
 * Finalmente, el resultado de la expresión es el último elemento en la pila de evaluación.
 */