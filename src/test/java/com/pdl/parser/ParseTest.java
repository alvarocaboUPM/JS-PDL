...
public class ParseTest {
    ...
    public void funcDecCallTest() {
        testFile += "t3.js";
        ok = "D\t 1 32 21 25 23 1 35 37 29 9 16 4 14 1 35 37 30 1 35 37 29 9 15 19 14 2 53 28 54 25 57 40 35 37 29 9 15 19 14 41 2 53 28 55 40 35 37 29 9 16 4 14 40 35 37 30 41 1 35 36 52 46 1 35 36 52 45 9 15 19 14 48 3 ";
        String res = p.parserDebug(testFile);
        assertTrue(Compiler.errors.isEmpty());
        assertEquals(ok, res);
    }
    ...
    public void funcDecCallTest2() {
        testFile += "t4.js";
        ok = "D\t 1 32 21 24 23 1 32 21 26 23 1 32 21 25 23 1 32 21 24 23 1 32 21 26 23 1 35 37 30 1 35 36 51 20 9 15 19 14 1 31 42 9 15 19 12 9 15 19 14 44 36 51 20 9 16 4 14 1 35 36 51 20 9 15 19 13 9 16 5 14 1 35 37 29 9 16 5 13 9 15 19 13 9 15 19 14 2 53 27 26 54 26 57 40 35 36 51 20 9 16 5 14 40 31 42 9 15 19 14 44 36 51 20 9 15 18 45 9 15 19 14 48 14 40 35 38 49 9 15 19 14 41 1 31 42 9 15 18 45 9 15 19 14 48 14 44 37 29 9 15 19 14 3 ";
        String res = p.parserDebug(testFile);
        assertTrue(Compiler.errors.isEmpty());
        assertEquals(ok, res);
    }
